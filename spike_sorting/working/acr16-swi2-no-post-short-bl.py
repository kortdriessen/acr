...
subject = 'ACR_16'
experiment = 'swi2'
recordings = ['swi2-bl', 'swi2-sd', 'swi2']
STORES = ["NNXo", "NNXr"]
...
sorting_analysis_name = ("ks2_5_nblocks=1_16s-batches")
rerun_existing = True
dry_run = False
hyp_paths = []

for STORE in STORES:
    output_dir = f'/ssd-raid0/analysis/acr_sorting/{subject}-{experiment}-{STORE}-no-post-short-bl/'
