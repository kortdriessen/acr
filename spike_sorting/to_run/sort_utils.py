...
def check_sorting_thresholds(threshes):
    params_path = '/home/kdriessen/github_t2/pipeline_tdt/pipeline_tdt/params/params.yaml'
    ...
    if threshes == proj_thresh:
        ...
        params[1]['analysis_params']['ks2_5_base']['projection_threshold'] = threshes[1:]
        params[1]['analysis_params']['ks2_5_base']['detect_threshold'] = threshes[0]
        for key in params[1]['analysis_params'].keys():
            if 'base' in key:
                continue
            params[1]['analysis_params'][key][1]['projection_threshold'] = params[1]['analysis_params']['ks2_5_base']['projection_threshold']
            params[1]['analysis_params'][key][1]['detect_threshold'] = params[1]['analysis_params']['ks2_5_base']['detect_threshold']
...
def check_probe_spacing(spacing):
    ...
    if spacing == probe_spacing:
        ...
        print('Probe spacing does not match params.yaml, updating params.yaml to', spacing)
