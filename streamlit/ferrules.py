...
user_path = st.text_input('Enter the path to the folder containing the ferrule data:', value = '/Volumes/opto_loc/Data/ACR_PROJECT_MATERIALS/ferrules/')
...
f = px.line(new_df, x='Time (s)', y='Power (uW)', color='Knob', facet_row='Fiber', title='Ferrule Calibration')
st.plotly_chart(f)
